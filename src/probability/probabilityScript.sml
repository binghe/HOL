...
val it =
  ...
  new definition: (moved to martingaleTheory.indep_functions_def)
 *)
Definition indep_vars :
    indep_vars = indep_functions (* see  *)
End
...
Definition converge_def :
   ...
   (* 4. X(n) converges to Y in distribution (see [4, p.306] or [2, p.96])
