...
Proof
 ...
 >> Rewr'
 >> Know ‘!t x. t IN s /\ x IN m_space m ==> Normal (g t x) <= w x’
 >- (qx_genl_tac [‘v’, ‘x’] >> STRIP_TAC \\
 ...
 >> Q.PAT_X_ASSUM ‘!t x. _ ==> Normal (diff1 (\t. u t x) t) <= _’ K_TAC
 >> DISCH_TAC
 (* stage work *)
  ...
  *)
 >> Q.PAT_X_ASSUM ‘open s’ (MP_TAC o (MATCH_MP (iffLR OPEN_CONTAINS_CBALL)))
