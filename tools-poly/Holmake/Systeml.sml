...
val HOLDIR = "/Users/binghe/ML/HOL.k15"
val MOSMLDIR = ""
val POLYMLLIBDIR = "/usr/local/lib"
val POLY = "/usr/local/bin/poly"
val POLYC = "/usr/local/bin/polyc"
val POLY_VERSION = PolyML.Compiler.compilerVersionNumber
val POLY_LDFLAGS = ["-L/usr/local/lib", "-lpolymain", "-lpolyml", "-lstdc++", "-Wl,-rpath,/usr/local/lib", "-Wl,-no_pie"]
val POLY_LDFLAGS_STATIC = ["-static", "-L/usr/local/lib", "-lpolymain", "-lpolyml", "-lstdc++", "-Wl,-rpath,/usr/local/lib", "-Wl,-no_pie"]
val CC = "cc"
val OS = "macosx"
...
val DOT_PATH = SOME "/opt/local/bin/dot"
val MV = "/bin/mv"
val CP = "/bin/cp"
