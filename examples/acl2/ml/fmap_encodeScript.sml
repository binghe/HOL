...
val LIST_LEX_ORDER_NIL = store_thm(
  "LIST_LEX_ORDER_NIL",
...
val consp_list_to_sexp = store_thm(
  "consp_list_to_sexp",
...
val STRING_LESS_EQ_REFL = store_thm(
  "STRING_LESS_EQ_REFL",
  ``STRING_LESS_EQ x x``,
...
val QSORT3_M2L_L2M_MAP_INV = store_thm("QSORT3_M2L_L2M_MAP_INV",
...
val INV_INV_IMAGE = store_thm("INV_INV_IMAGE",
